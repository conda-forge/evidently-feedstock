...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/evidently-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13724&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/evidently-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `evidently` can be installed with:

```
conda install evidently
```

It is possible to list all of the versions of `evidently` available on your platform with:
